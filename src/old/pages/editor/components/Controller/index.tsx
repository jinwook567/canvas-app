...
import AssetList from 'old/pages/editor/components/AssetList';
import {
  figureAsset,
  imageAsset,
  templateAsset,
  textAsset,
} from 'old/pages/editor/components/Controller/constant';
import useSelect from 'old/hooks/editor/stage/useSelect';
import useAdd from 'old/hooks/editor/node/useAdd';
import useTransform from 'old/hooks/editor/stage/useTransform';
import { isShape, Node } from 'old/utils/editor/node';
import AssetUpload from 'old/pages/editor/components/AssetUpload';
import { useRecoilValue } from 'recoil';
import { selectedTabState, tabValue } from 'old/recoils/editor/atoms';
import PositionHandler from 'old/pages/editor/components/PositionHandler';
