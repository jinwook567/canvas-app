...
import usePressedKey from 'old/hooks/editor/global/usePressedKey';
import useSelect from 'old/hooks/editor/node/useSelect';
import { Shape } from 'old/utils/editor/node';
import Selector from 'old/components/editor/Selector';
import ShapeMatcher from 'old/pages/editor/components/ShapeMatcher';
import { useSafeRef } from 'shared/dom';
import useApplySelectRules from 'old/pages/editor/components/ShapeWithSelector/selectRule';
